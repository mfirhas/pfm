...
impl Money {
    ...
    pub(super) fn convert(rates: &RatesData, from: Money, to: Currency) -> ForexResult<Money> {
        ...
        let to_base = match from {
            Money::USD(amount) => amount / rates.usd,
            Money::CAD(amount) => amount / rates.cad,
            Money::EUR(amount) => amount / rates.eur,
            Money::GBP(amount) => amount / rates.gbp,
            Money::CHF(amount) => amount / rates.chf,
            Money::RUB(amount) => amount / rates.rub,
            Money::CNY(amount) => amount / rates.cny,
            Money::JPY(amount) => amount / rates.jpy,
            Money::KRW(amount) => amount / rates.krw,
            Money::HKD(amount) => amount / rates.hkd,
            Money::IDR(amount) => amount / rates.idr,
            Money::MYR(amount) => amount / rates.myr,
            Money::SGD(amount) => amount / rates.sgd,
            Money::THB(amount) => amount / rates.thb,
            Money::SAR(amount) => amount / rates.sar,
            Money::AED(amount) => amount / rates.aed,
            Money::KWD(amount) => amount / rates.kwd,
            Money::INR(amount) => amount / rates.inr,
            Money::AUD(amount) => amount / rates.aud,
            Money::NZD(amount) => amount / rates.nzd,
            ...
            Money::XRP(amount) => amount / rates.xrp,
            Money::ADA(amount) => amount / rates.ada,
        };
